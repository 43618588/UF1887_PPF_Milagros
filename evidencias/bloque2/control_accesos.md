...
## Objetivo
Aplicar medidas de seguridad sobre el sistema ERP mediante la modificación de permisos incorrectos, creación de perfiles de seguridad y limitación de accesos a módulos sensibles.
---
...
| admin | Uso general del sistema | Recomendación de uso exclusivo para administración |
...
---
## 5. Conclusión
Las modificaciones aplicadas permiten mejorar la seguridad del sistema mediante la reducción de privilegios innecesarios y la correcta separación de funciones entre usuarios.